...
grid_search_parameters = {
    ...
    'schedule': [mlrose.ArithDecay(1), mlrose.ArithDecay(10)]
}
...
run_stats_df.to_csv(os.path.join("experiments", "beans_SA_NNGSRunner_stats.csv"), header=True)
curves_df.to_csv(os.path.join("experiments", "beans_SA_NNGSRunner_curves.csv"), header=True)
cv_results_df.to_csv(os.path.join("experiments", "beans_SA_NNGSRunner_results.csv"), header=True)
with open('experiments/beans_SA_NNGSRunner_grid.txt', "w") as f:
