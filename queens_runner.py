...
df_run_stats.to_csv(os.path.join("experiments", "queens_SA_stats.csv"), header=True)
df_run_curves.to_csv(os.path.join("experiments", "queens_SA_curves.csv"), header=True)
...
# the two data frames will contain the results
df_run_stats, df_run_curves = runner.run()
df_run_stats.to_csv(os.path.join("experiments", "queens_RHC_stats.csv"), header=True)
df_run_curves.to_csv(os.path.join("experiments", "queens_RHC_curves.csv"), header=True)
...
# the two data frames will contain the results
df_run_stats, df_run_curves = runner.run()
df_run_stats.to_csv(os.path.join("experiments", "queens_GA_stats.csv"), header=True)
df_run_curves.to_csv(os.path.join("experiments", "queens_GA_curves.csv"), header=True)
...
# the two data frames will contain the results
df_run_stats, df_run_curves = runner.run()
df_run_stats.to_csv(os.path.join("experiments", "queens_MIMIC_stats.csv"), header=True)
df_run_curves.to_csv(os.path.join("experiments", "queens_MIMIC_curves.csv"), header=True)
print("")
