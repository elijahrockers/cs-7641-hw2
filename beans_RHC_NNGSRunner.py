...
run_stats_df.to_csv(os.path.join("experiments", "beans_RHC_NNGSRunner_stats.csv"), header=True)
curves_df.to_csv(os.path.join("experiments", "beans_RHC_NNGSRunner_curves.csv"), header=True)
cv_results_df.to_csv(os.path.join("experiments", "beans_RHC_NNGSRunner_results.csv"), header=True)
with open('experiments/beans_RHC_NNGSRunner_grid.txt', "w") as f:
